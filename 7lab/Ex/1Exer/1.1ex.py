...
clock_img = pygame.image.load(r"C:\Users\Алим\OneDrive\Desktop\python\7lab\Ex\1Exer\clock.jpeg")
clock_face = pygame.transform.scale(clock_img, (WIDTH, HEIGHT))
hand_right = pygame.image.load(r"C:\Users\Алим\OneDrive\Desktop\python\7lab\Ex\1Exer\rightarm.png")
hand_left = pygame.image.load(r"C:\Users\Алим\OneDrive\Desktop\python\7lab\Ex\1Exer\leftarm.png")
