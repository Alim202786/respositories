...
def menu():
    while True:
        print("\nPHONEBOOK MENU:")
        print("1. Добавить или обновить пользователя (через процедуру)")
        print("2. Поиск по шаблону (через функцию)")
        print("3. Удалить по имени или номеру (через процедуру)")
        print("4. Массовая загрузка из CSV (через процедуру)")
        print("5. Постраничный вывод (через функцию)")
        print("0. Выход")
